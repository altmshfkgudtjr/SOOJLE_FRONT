...
function Congratulations() {
    ...
    $("body").append(cake_div_container);
    setTimeout(function() {
    	$("#congratulations_wrapper").css("transform", "translate(0, 0)");
    }, 400);
}
function Congratulations_close() {
	$("#congratulations_wrapper").css("transform", "translate(0, 100%)");
